      ...
      <>
        <section className="oneday-trips-section flex-col">
          ...
          <p className="oneday-trips-title dark-grey">
            Poznaj uroki Nidy podczas jednodniowych spływów kajakowych
            dopasowanych do każdego poziomu zaawansowania. Od spokojnych tras
            rodzinnych po bardziej wymagające odcinki - każda z nich pozwala
            cieszyć się pięknem natury, aktywnym wypoczynkiem i wyjątkową
            atmosferą rzeki.
          </p>
          ...
          <div className="flex-row oneday-trips-row">
            <div className="oneday-trips-img ">
              <img
                src={oneDayTrips}
                alt="Mapa tras spływów rodzinnych"
