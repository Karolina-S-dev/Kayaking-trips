    ...
    <>
      <section className="oneday-trips-section flex-col">
        ...
        <p className="onrequest-trips-title dark-grey">
          Marzysz o prawdziwej kajakowej ekspedycji?
          <br />
          Przygotujemy wyprawę dopasowana do Ciebie i Twojej ekipy.
        </p>
        ...
        <div className="flex-row onrequest-trips-row">
          ...
          <div className="flex-col onrequest-routes-content">
            ...
            <p className="onrequest-desc">
              ...
              jej ujścia do Wisły, możliwe jest kontynuowanie spływu już nurtem
              największej rzeki w Polsce.
            </p>
            ...
            <p className="onrequest-desc">
              Każdą wyprawę dopasowujemy do doświadczenia uczestników, planując
              długość trasy, miejsca noclegowe, etapy dzienne oraz transport.
            </p>
        ...
        <div className="flex-row onrequest-cards">
          <div className="onrequest-card box-shadow">
            ...
            <p className="onrequest-card-content">Indywidualne dopasowanie trasy i czasu wyprawy</p>
          </div>
          <div className="onrequest-card box-shadow">
            <img src={tent} alt="icon" />
            <p className="onrequest-card-title">Noclegi</p>
            <p className="onrequest-card-content">Dobór miejsc biwakowych lub noclegowych</p>
          </div>
          <div className="onrequest-card box-shadow">
            <img src={part} alt="icon" />
            <p className="onrequest-card-title">Etapy dzienne</p>
            <p className="onrequest-card-content">Planowanie etapów dziennych</p>
          </div>
          <div className="onrequest-card box-shadow">
            <img src={car} alt="icon" />
            <p className="onrequest-card-title">Transport</p>
            <p className="onrequest-card-content">Pełną logistykę i transport uczestników</p>
          </div>
          <div className="onrequest-card box-shadow">
            <img src={program} alt="icon" />
            <p className="onrequest-card-title">Program</p>
            <p className="onrequest-card-content">Dopasowany do doświadczenia grupy</p>
          </div>
        </div>
