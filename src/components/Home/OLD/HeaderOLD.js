...
//               className={`nav-button ${activePage === "/trasy-splywow" ? "active-nav-button" : ""}`}
//             >
...
//               className={`nav-button ${activePage === "/galeria" ? "active-nav-button" : ""}`}
//             >
...
//           </li>
//         </ul>
//         <button className="hamburger-button white">
